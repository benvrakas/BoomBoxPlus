...
public class BoomBoxPlus : ModuleRules
{
	public BoomBoxPlus(ReadOnlyTargetRules Target) : base(Target)
	{
		PCHUsage = PCHUsageMode.UseExplicitOrSharedPCHs;
		CppStandard = CppStandardVersion.Cpp20;

		// Compiles each source file separately so vendored decoder macros never leak between files.
		bUseUnity = false;
		...
		PrivateIncludePaths.AddRange(new string[] {
			Path.Combine(ModuleDirectory, "..", "ThirdParty", "BBPAudioDecoders"),
		});
